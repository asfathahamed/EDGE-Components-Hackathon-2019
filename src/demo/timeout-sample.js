...
import SessionTimeOut from "../components/timeout/js/timeout-component.js";
import "../components/timeout/css/timeout-component.css";
...
class SessionTimeOutSample extends Component {
  ...
  handleModalSizeChange = this.handleModalSizeChange.bind(this);
  ...
  handleStartSession() {
	if(this.state.inActivityTime > 0 && this.state.promptTime > 0) {
		this.setState({
			showTimeOut: true
		});
	} else {
              ...
              <MDBCard className="sessionTimeOutSection">
                ...
                <MDBCardBody>
                  <form>
                    ...
                    <MDBRow className="mt-4 mb-4">
					  <MDBCol md="4" lg="4">
                        <label className="grey-text">Modal size</label>
                        <select
                          value={this.state.sizeModal}
                    ...
                    <MDBRow className="mt-4 mb-4" style={{textAlign: 'center'}}>
                      <MDBCol lg="12">
                        <MDBBtn
