...
export class Splitter extends React.Component {
  ...
  /**
   * This function calculate size of the secondary pane and return it, while resizing.
   * @param {object} containerRect - object of 'element.getBoundingClientRect()'
   * @param {object} splitterRect - object of 'element.getBoundingClientRect()'
   * @param {object} clientPosition - mouse position "{left, top}"
   * @param {boolean} offsetMouse - true/false
   * @returns - new size to assign secondary pane
   */
