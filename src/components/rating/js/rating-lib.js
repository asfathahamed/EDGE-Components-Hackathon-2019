...
var BarRating = (function() {
  function BarRating() {
    ...
    var getEmptyOption = function() {
      var $emptyOpt = self.$elem.find(
        'option[value="' + self.options.emptyValue + '"]'
      );
    ...
    this.set = function(value) {
      ...
      setData(
        "ratingText",
        self.$elem.find('option[value="' + value + '"]').text()
      );
      setData("ratingMade", true);
