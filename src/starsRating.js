...
class StarRatingComponent extends Component {
  ...
  constructor(props) {
    ...
    this.state.config = {
      ...
      defaulfStarColor: props.defaulfStarColor,
      // Active star color
      fillfStarColor: props.fillfStarColor,
      half: props.half,
      edit: props.edit,
    }
  ...
  renderHalfStarStyleElement() {
    ...
    return (
      <style dangerouslySetInnerHTML={{
        __html: getHalfStarStyles(config.fillfStarColor, uniqueness)
      }}></style>
    )
  }
  ...
  renderStars() {
    ...
    const { defaulfStarColor, fillfStarColor, starSize, char, half, edit } = config
    return stars.map((star, i) => {
      ...
      const style = Object.assign({}, starsDefaultStyles, {
        color: star.active ? fillfStarColor : defaulfStarColor,
...
StarRatingComponent.propTypes = {
  ...
  defaulfStarColor: PropTypes.string,
  fillfStarColor: PropTypes.string
}
...
StarRatingComponent.defaultProps = {
  ...
  char: '★',
  size: 15,
  defaulfStarColor: 'gray',
  fillfStarColor: '#333333',
